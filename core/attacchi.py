...
# Simula i vari attacchi.
def comprimi_jpeg(
    immagine: NDArray[np.uint8],
    quality: int = 50,
) -> NDArray[np.uint8]:
    # Simulo la compressione salvando e ricaricando l'immagine in memoria
...
def aggiungi_rumore_gaussiano(
    ...
    # Aggiungo rumore gaussiano all'immagine
...
def aggiungi_rumore_salt_pepper(
    ...
    # Aggiungo rumore (metà pixel diventano bianchi, metà neri)
...
def ritaglia(
    ...
    # Simula un ritaglio oscurando l'angolo in alto a sinistra con un quadrato nero
...
def ruota(
    ...
    # Ruota l'immagine partendo dal centro.
